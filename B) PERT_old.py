...
layout = go.Layout(
    title=f"Pertussis vaccination coverage vs reported case incidence rate for different countries,DTP-containing vaccine max(1st or 3rd dose)<br>{slope_text} {year_range_text}",
